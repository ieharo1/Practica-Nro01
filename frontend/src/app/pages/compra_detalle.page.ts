import { Component } from '@angular/core';
    ...
    import { CompraDetalleService } from '../services/compra_detalle.service';

    @Component({
      selector: 'app-compra_detalle-page',
      standalone: true,
      ...
      template: `
        <mat-card class="page-card">
          ...
          <form [formGroup]="form" (ngSubmit)="save()" class="form-grid">
            <mat-form-field appearance=\"outline\"><mat-label>compraId</mat-label><input matInput type=\"number\" formControlName=\"compraId\" /></mat-form-field>
  ...
  <th mat-header-cell *matHeaderCellDef>compraId</th>
  <td mat-cell *matCellDef="let row">{{row.compraId}}</td>
</ng-container>
  ...
  <td mat-cell *matCellDef="let row">
    ...
    export class CompraDetallePage {
      items: any[] = [];
      displayedColumns = ['id', 'compraId', 'productoId', 'cantidad', 'precioUnitario', 'subtotal', 'acciones'];
      ...
      constructor(private fb: FormBuilder, private service: CompraDetalleService) {
        this.load();
      }
